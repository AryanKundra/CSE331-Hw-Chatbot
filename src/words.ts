...
/**
 * This program mutates an array of words based on a specified map or replacements
 * @param words The array of words to be mutated
 * @param reps The map of keywords to replace words
 * @returns - void, the function directly mutates the input array
 * @throws TypeError if the input parameters are not the correct types (words:array, reps:map)
 * 
 *@description
 * The program mutates an array of words buy subsittituing words in the array with corresponding values from a given map
 * If a word is listed as a key in the map, it is replaced, otherwise it remains unchanged
 * the program directly mutates input array when the program is called
 * 
 */
